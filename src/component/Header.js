...
function Header() {
    ...
    return (
        ...
        <h1 className='h12Header01'>Mon Petit Poney, version revisitée.</h1> 
        <h2 className='h12Header01'>CSS inspiré par les réalisations de David.</h2>
        <nav className='navHeader01'>
            <ul className='ulHeader01'>
                ...
                <li className='liHeader01'><Link to="/about">A propos</Link></li>                  
            </ul>
        </nav>
        </header>
    )
